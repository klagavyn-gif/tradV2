...
def handle_telegram_alert_report_request():
    ...
    payload = {
        ...
        "files": {
            ...
            "live_feedback_export_csv": trad._alert_feedback_export_file_path(),
            "live_feedback_summary_json": trad._alert_feedback_summary_file_path(),
            "live_feedback_training_csv": trad._live_feedback_training_dataset_file_path(),
            "live_feedback_training_summary_json": trad._live_feedback_training_summary_file_path(),
            "live_feedback_calibration_csv": trad._live_feedback_calibration_dataset_file_path(),
            "live_feedback_calibration_summary_json": trad._live_feedback_calibration_summary_file_path(),
            "live_feedback_shadow_eval_csv": trad._live_feedback_shadow_eval_file_path(),
            "live_feedback_shadow_summary_json": trad._live_feedback_shadow_summary_file_path(),
