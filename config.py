...
TELEGRAM_ALERT_ENTRY_AI_LIVE_STRATEGIES = _env_csv_set("TELEGRAM_ALERT_ENTRY_AI_LIVE_STRATEGIES", "CDCVIX15")
...
TELEGRAM_ALERT_SLTP_LIVE_STRATEGIES = _env_csv_set("TELEGRAM_ALERT_SLTP_LIVE_STRATEGIES", "CDCVIX15")
