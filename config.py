...
TELEGRAM_ALERT_AUTO_TUNE_HISTORY_DAYS = _env_int("TELEGRAM_ALERT_AUTO_TUNE_HISTORY_DAYS", 30)
...
TELEGRAM_ALERT_AUTO_TUNE_RECENT_HALF_LIFE_DAYS = _env_float("TELEGRAM_ALERT_AUTO_TUNE_RECENT_HALF_LIFE_DAYS", 9.0)
TELEGRAM_ALERT_AUTO_TUNE_FRESH_SIGNAL_MAX_BARS = _env_int("TELEGRAM_ALERT_AUTO_TUNE_FRESH_SIGNAL_MAX_BARS", 48)
TELEGRAM_ALERT_AUTO_TUNE_STALE_SIGNAL_START_BARS = _env_int("TELEGRAM_ALERT_AUTO_TUNE_STALE_SIGNAL_START_BARS", 160)
TELEGRAM_ALERT_AUTO_TUNE_STALE_SIGNAL_MIN_WEIGHT = _env_float("TELEGRAM_ALERT_AUTO_TUNE_STALE_SIGNAL_MIN_WEIGHT", 0.45)
TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_BLEND_FULL_ALERTS = _env_int("TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_BLEND_FULL_ALERTS", 36)
TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_MIN_BLEND_WEIGHT = _env_float("TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_MIN_BLEND_WEIGHT", 0.15)
TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_CONFIDENCE_CAP_OVER_STRATEGY = _env_float("TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_CONFIDENCE_CAP_OVER_STRATEGY", 2.0)
TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_SELL_WIN_RATE_CAP_OVER_BASE = _env_float("TELEGRAM_ALERT_AUTO_TUNE_SYMBOL_SELL_WIN_RATE_CAP_OVER_BASE", 0.5)
...
TELEGRAM_ALERT_STRATEGY_QUALITY_PROFILES = {
    ...
    "CDCVIX15": {
        ...
        "sell_min_win_rate_pct": 65.0,
        "buy_min_expectancy_rr": 0.04,
        "sell_min_expectancy_rr": 0.10,
        "min_trades": 8,
        "sell_min_robustness_score": 50.0,
    },
    "AZ15": {
        "min_confidence": 74.0,
        "min_score": 78.0,
