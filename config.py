...
TELEGRAM_ALERT_EXIT_MIN_CONFIDENCE = _env_float("TELEGRAM_ALERT_EXIT_MIN_CONFIDENCE", 60.0)
...
TELEGRAM_KILL_SWITCH_EXIT_RATIO = _env_float("TELEGRAM_KILL_SWITCH_EXIT_RATIO", 0.50)
...
ACTIONZONE_15M_PRECISION60_ENABLED = _env_bool("ACTIONZONE_15M_PRECISION60_ENABLED", False)
...
CDC_VIXFIX_15M_YF_PERIOD = _env_str("CDC_VIXFIX_15M_YF_PERIOD", "30d")
