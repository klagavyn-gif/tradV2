...
TELEGRAM_ALERT_SELL_CONTINUATION_MIN_CONFIDENCE = _env_float("TELEGRAM_ALERT_SELL_CONTINUATION_MIN_CONFIDENCE", 88.0)
TELEGRAM_ALERT_SELL_CONTINUATION_MIN_FORECAST_SCORE = _env_float("TELEGRAM_ALERT_SELL_CONTINUATION_MIN_FORECAST_SCORE", 80.0)
TELEGRAM_ALERT_SELL_CONTINUATION_MAX_BARS_SINCE_SIGNAL = _env_int("TELEGRAM_ALERT_SELL_CONTINUATION_MAX_BARS_SINCE_SIGNAL", 2)
TELEGRAM_ALERT_SELL_CONTINUATION_MAX_DISTANCE_PCT = _env_float("TELEGRAM_ALERT_SELL_CONTINUATION_MAX_DISTANCE_PCT", 3.6)
TELEGRAM_ALERT_SELL_CONTINUATION_MAX_DISTANCE_R = _env_float("TELEGRAM_ALERT_SELL_CONTINUATION_MAX_DISTANCE_R", 1.5)
