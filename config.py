...
TELEGRAM_ALERT_MIN_CONFIDENCE = _env_float("TELEGRAM_ALERT_MIN_CONFIDENCE", 82.0)
...
TELEGRAM_ALERT_ENTRY_MIN_HIST_WIN_RATE = _env_float("TELEGRAM_ALERT_ENTRY_MIN_HIST_WIN_RATE", 60.0)
TELEGRAM_ALERT_ENTRY_MIN_HIST_TRADES = _env_int("TELEGRAM_ALERT_ENTRY_MIN_HIST_TRADES", 8)
TELEGRAM_ALERT_ENTRY_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_ENTRY_MIN_EXPECTANCY_RR", 0.05)
...
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_WIN_RATE = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_WIN_RATE", 60.0)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_EXPECTANCY_RR", 0.05)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_VALID_TRADES = _env_int("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_VALID_TRADES", 6)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_ROBUSTNESS = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_ROBUSTNESS", 45.0)
TELEGRAM_ALERT_STRICT_60_MODE = _env_bool("TELEGRAM_ALERT_STRICT_60_MODE", True)
TELEGRAM_ALERT_STRICT_60_EXCLUDE_CDC = _env_bool("TELEGRAM_ALERT_STRICT_60_EXCLUDE_CDC", True)
TELEGRAM_ALERT_SELL_WHITELIST_ENABLE = _env_bool("TELEGRAM_ALERT_SELL_WHITELIST_ENABLE", True)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_WIN_RATE = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_WIN_RATE", 60.0)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_EXPECTANCY_RR", 0.05)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_VALID_TRADES = _env_int("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_VALID_TRADES", 6)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_ROBUSTNESS = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_ROBUSTNESS", 45.0)
TELEGRAM_ALERT_PRIMARY_MIN_SOURCES = _env_int("TELEGRAM_ALERT_PRIMARY_MIN_SOURCES", 2)
TELEGRAM_ALERT_PRIMARY_SINGLE_SOURCE_MIN_CONF = _env_float("TELEGRAM_ALERT_PRIMARY_SINGLE_SOURCE_MIN_CONF", 90.0)
...
TELEGRAM_DAILY_BEST_PICK_MIN_CONFIDENCE = _env_float("TELEGRAM_DAILY_BEST_PICK_MIN_CONFIDENCE", 55.0)
TELEGRAM_DAILY_BEST_PICK_MIN_SCORE = _env_float("TELEGRAM_DAILY_BEST_PICK_MIN_SCORE", 72.0)
...
ACTIONZONE_15M_MIN_ALERT_CONFIDENCE = _env_float("ACTIONZONE_15M_MIN_ALERT_CONFIDENCE", 82.0)
