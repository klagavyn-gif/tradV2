...
TELEGRAM_ALERT_MIN_CONFIDENCE = _env_float("TELEGRAM_ALERT_MIN_CONFIDENCE", 72.0)
...
TELEGRAM_ALERT_COOLDOWN_MINUTES = _env_int("TELEGRAM_ALERT_COOLDOWN_MINUTES", 30)
...
TELEGRAM_ALERT_DYNAMIC_CONF_VOL_MULT = _env_float("TELEGRAM_ALERT_DYNAMIC_CONF_VOL_MULT", 2.5)
TELEGRAM_ALERT_ENTRY_QUALITY_ENABLE = _env_bool("TELEGRAM_ALERT_ENTRY_QUALITY_ENABLE", True)
TELEGRAM_ALERT_ENTRY_MIN_HIST_WIN_RATE = _env_float("TELEGRAM_ALERT_ENTRY_MIN_HIST_WIN_RATE", 54.0)
TELEGRAM_ALERT_ENTRY_MIN_HIST_TRADES = _env_int("TELEGRAM_ALERT_ENTRY_MIN_HIST_TRADES", 5)
TELEGRAM_ALERT_ENTRY_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_ENTRY_MIN_EXPECTANCY_RR", 0.0)
TELEGRAM_ALERT_ENTRY_REQUIRE_EDGE_METRICS = _env_bool("TELEGRAM_ALERT_ENTRY_REQUIRE_EDGE_METRICS", False)
TELEGRAM_ALERT_ENTRY_REQUIRE_WALKFORWARD = _env_bool("TELEGRAM_ALERT_ENTRY_REQUIRE_WALKFORWARD", False)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_WIN_RATE = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_WIN_RATE", 55.0)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_EXPECTANCY_RR", 0.0)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_VALID_TRADES = _env_int("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_VALID_TRADES", 4)
TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_ROBUSTNESS = _env_float("TELEGRAM_ALERT_ENTRY_WALKFORWARD_MIN_ROBUSTNESS", 35.0)
TELEGRAM_ALERT_STRICT_60_MODE = _env_bool("TELEGRAM_ALERT_STRICT_60_MODE", False)
TELEGRAM_ALERT_STRICT_60_EXCLUDE_CDC = _env_bool("TELEGRAM_ALERT_STRICT_60_EXCLUDE_CDC", False)
TELEGRAM_ALERT_SELL_WHITELIST_ENABLE = _env_bool("TELEGRAM_ALERT_SELL_WHITELIST_ENABLE", False)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_WIN_RATE = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_WIN_RATE", 55.0)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_EXPECTANCY_RR = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_EXPECTANCY_RR", 0.0)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_VALID_TRADES = _env_int("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_VALID_TRADES", 4)
TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_ROBUSTNESS = _env_float("TELEGRAM_ALERT_SELL_WALKFORWARD_MIN_ROBUSTNESS", 35.0)
TELEGRAM_ALERT_PRIMARY_MIN_SOURCES = _env_int("TELEGRAM_ALERT_PRIMARY_MIN_SOURCES", 1)
TELEGRAM_ALERT_PRIMARY_SINGLE_SOURCE_MIN_CONF = _env_float("TELEGRAM_ALERT_PRIMARY_SINGLE_SOURCE_MIN_CONF", 78.0)
...
TELEGRAM_DAILY_BEST_PICK_WINDOW_MINUTES = _env_int("TELEGRAM_DAILY_BEST_PICK_WINDOW_MINUTES", 15)
TELEGRAM_DAILY_BEST_PICK_MIN_CONFIDENCE = _env_float("TELEGRAM_DAILY_BEST_PICK_MIN_CONFIDENCE", 52.0)
TELEGRAM_DAILY_BEST_PICK_MIN_SCORE = _env_float("TELEGRAM_DAILY_BEST_PICK_MIN_SCORE", 68.0)
TELEGRAM_DAILY_BEST_PICK_MAX_PER_DAY = _env_int("TELEGRAM_DAILY_BEST_PICK_MAX_PER_DAY", 3)
TELEGRAM_DAILY_BEST_PICK_REQUIRE_QUALITY = _env_bool("TELEGRAM_DAILY_BEST_PICK_REQUIRE_QUALITY", False)
TELEGRAM_DAILY_BEST_PICK_ALLOW_CDC = _env_bool("TELEGRAM_DAILY_BEST_PICK_ALLOW_CDC", True)
TELEGRAM_KILL_SWITCH_ENABLED = _env_bool("TELEGRAM_KILL_SWITCH_ENABLED", True)
