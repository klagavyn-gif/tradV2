...
TELEGRAM_ALERT_ENTRY_AI_FILTER_ENABLE = _env_bool("TELEGRAM_ALERT_ENTRY_AI_FILTER_ENABLE", False)
...
TELEGRAM_ALERT_ENTRY_AI_MODEL_PATH = _env_str("TELEGRAM_ALERT_ENTRY_AI_MODEL_PATH", "")
