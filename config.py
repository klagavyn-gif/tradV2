...
TELEGRAM_ALERT_ENTRY_AI_LIVE_STRATEGIES = _env_csv_set("TELEGRAM_ALERT_ENTRY_AI_LIVE_STRATEGIES", "")
TELEGRAM_ALERT_ENTRY_AI_LIVE_GROUPS = _env_csv_set("TELEGRAM_ALERT_ENTRY_AI_LIVE_GROUPS", "PRIMARY,DAILY")
