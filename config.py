...
MARKET_DATA_PROVIDER = _env_str("MARKET_DATA_PROVIDER", "yahoo").strip().lower() or "yahoo"
...
TELEGRAM_ALERT_SELL_CONTINUATION_ENTRY_MIN_HIST_WIN_RATE = _env_float("TELEGRAM_ALERT_SELL_CONTINUATION_ENTRY_MIN_HIST_WIN_RATE", 55.0)
