...
TELEGRAM_ALERT_PRIMARY_DIVERSITY_ENABLE = _env_bool("TELEGRAM_ALERT_PRIMARY_DIVERSITY_ENABLE", True)
TELEGRAM_ALERT_PRIMARY_DIVERSITY_STRATEGIES = _env_csv_set("TELEGRAM_ALERT_PRIMARY_DIVERSITY_STRATEGIES", "PRIMARY,SS15")
TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_TIER = _env_str("TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_TIER", "B")
TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_COMPOSITE_SCORE = _env_float("TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_COMPOSITE_SCORE", 80.0)
TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_CONFIDENCE = _env_float("TELEGRAM_ALERT_PRIMARY_DIVERSITY_MIN_CONFIDENCE", 78.0)
TELEGRAM_ALERT_PRIMARY_INCLUDE_EXIT = _env_bool("TELEGRAM_ALERT_PRIMARY_INCLUDE_EXIT", False)
TELEGRAM_ALERT_ENTRY_MAX_DISTANCE_PCT = _env_float("TELEGRAM_ALERT_ENTRY_MAX_DISTANCE_PCT", 2.5)
TELEGRAM_ALERT_ENTRY_MAX_DISTANCE_R = _env_float("TELEGRAM_ALERT_ENTRY_MAX_DISTANCE_R", 1.1)
TREND_RADAR_INCLUDE_WATCH = _env_bool("TREND_RADAR_INCLUDE_WATCH", False)
TREND_RADAR_INCLUDE_EXIT = _env_bool("TREND_RADAR_INCLUDE_EXIT", False)
...
TREND_RADAR_ENABLED = _env_bool("TREND_RADAR_ENABLED", False)
TREND_RADAR_MIN_SCORE = _env_float("TREND_RADAR_MIN_SCORE", 74.0)
TREND_RADAR_MIN_1H_CONFIDENCE = _env_float("TREND_RADAR_MIN_1H_CONFIDENCE", 68.0)
TREND_RADAR_MIN_PLAN_CONFIDENCE = _env_float("TREND_RADAR_MIN_PLAN_CONFIDENCE", 62.0)
TREND_RADAR_MIN_ADX = _env_float("TREND_RADAR_MIN_ADX", 20.0)
TREND_RADAR_MIN_RVOL = _env_float("TREND_RADAR_MIN_RVOL", 1.05)
TREND_RADAR_MAX_ENTRY_RISK_PCT = _env_float("TREND_RADAR_MAX_ENTRY_RISK_PCT", 4.5)
TREND_RADAR_COOLDOWN_MINUTES = _env_int("TREND_RADAR_COOLDOWN_MINUTES", 240)
TREND_RADAR_MAX_PER_RUN = _env_int("TREND_RADAR_MAX_PER_RUN", 2)
TREND_RADAR_MAX_TOTAL_PER_SYMBOL = _env_int("TREND_RADAR_MAX_TOTAL_PER_SYMBOL", 1)
TREND_RADAR_SUPPRESS_IF_PRIMARY_SENT = _env_bool("TREND_RADAR_SUPPRESS_IF_PRIMARY_SENT", True)
TREND_RADAR_REQUIRE_REGIME_CONFIRMATION = _env_bool("TREND_RADAR_REQUIRE_REGIME_CONFIRMATION", True)
TREND_RADAR_START_ENABLED = _env_bool("TREND_RADAR_START_ENABLED", True)
TREND_RADAR_CONTINUE_ENABLED = _env_bool("TREND_RADAR_CONTINUE_ENABLED", True)
