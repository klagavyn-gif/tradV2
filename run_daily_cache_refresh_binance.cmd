...
echo ============================================
echo Daily Cache Refresh - Binance Local
echo ============================================
echo.
...
echo 3. Skip rebuilding Phase 1 dataset
echo 4. Save a log under .data\research\logs
echo.

powershell -ExecutionPolicy Bypass -File "%ROOT%tools\daily_cache_refresh_binance.ps1"
